            ...
            <div className="relative max-w-2xl mx-auto mb-6">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-12 py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-lg"
                    />
                    {query && (
                        <motion.button
                ...
                <div className="flex justify-center mt-4">
                    ...
                    {(query || selectedCategory !== 'all') && (
                        <motion.button
                            ...
                            onClick={handleReset}
                            className="ml-4 px-6 py-2 bg-gray-100 text-gray-700 rounded-lg font-semibold hover:bg-gray-200 transition-colors"
                        >
                            Clear Filters
                        </motion.button>
                    )}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mt-4">
                        <details className="inline-block">
                            <summary className="text-blue-600 hover:text-blue-700 font-medium cursor-pointer">
                                More categories
                            </summary>
